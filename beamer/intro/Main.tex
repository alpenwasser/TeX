...
\begin{frame} % -------------------------------------------------------- FRAME %
    ...
    \begin{itemize}
        ...
        \item
            macOS: z.B. TeXShop
        \item
            Texmaker, TeXstudio, Gummi, \ldots
        \item
            WYSIWYM: LyX
        ...
        \begin{overprint} % ---------------------------------- OVERPRINT %
            ...
            \begin{tikzpicture}[
                ...
                \node (pdflatex) 
                    ...
                    {pdflatex};
                \coordinate [right=of pdflatex] (target);

                \draw [very thick,-{stealth}] (source) |- (pdflatex.west);
                \draw [very thick,-{stealth}] ($(pdflatex.east) - (0.7mm,0mm)$) -- (target);
            \end{tikzpicture}
        \end{overprint}
        ...
        \begin{tikzpicture}[
            ...
            \begin{overprint} % ------------------------------ OVERPRINT %
                ...
                \begin{scope}[
                    ...
                    every spy on node/.style={circle,solarized-red,draw},
                    ...
                    \node
                        ...
                        at (1,0) 
                        {\includegraphics[height=5.5cm]{code/simplest.pdf}};
                    \spy[red] on ($(inclPage.north west)+(9.15mm,-6.5mm)$) in node at (3,-1);
                \end{scope}
            \end{overprint}
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}<beamer:0>[fragile] % ------------------------------------- FRAME %
